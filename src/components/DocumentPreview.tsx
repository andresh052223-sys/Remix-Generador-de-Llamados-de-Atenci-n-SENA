...
export const DocumentPreview: React.FC<DocumentPreviewProps> = ({
  ...
  const isSinglePageDoc = evidences.length <= 8;
  const page1Evidences = isSinglePageDoc ? evidences : evidences.slice(0, 8);
  const page2Evidences = isSinglePageDoc ? [] : evidences.slice(8);
          ...
          {(isSinglePageDoc || currentPageView === 1) && (
            <div className="flex flex-col justify-between min-h-[980px]">
              <div>
                ...
                <div className="border border-black text-xs mb-4">
                  ...
                  {page1Evidences.length === 0 ? (
                    <div className="grid grid-cols-12 min-h-8 items-center text-center">
                      ...
                      <div className="col-span-6 p-1.5 border-r border-black text-[11px] text-slate-500 italic">
                      ...
                      <div className="col-span-3 p-1.5 text-[10px] text-slate-500">-</div>
                    </div>
                  ) : (
                ...
                {/* If single page doc, render JUICIO and SIGNATURES directly on Page 1 */}
                {isSinglePageDoc && (
                  <>
                    {/* JUICIO Section */}
                    <div className="border border-black text-xs grid grid-cols-12 mb-6 mt-4">
              ...
              <div>
                ...
                <div className="border border-black text-xs mb-5">
                  ...
                  <div className="grid grid-cols-12 border-b border-black text-center font-bold text-[10.5px]">
                    ...
                    <div className="col-span-6 p-1.5 border-r border-black flex items-center justify-center uppercase">EVIDENCIAS</div>
                    ...
                    <div className="col-span-3 p-1.5 flex items-center justify-center uppercase">OBSERVACIONES</div>
                  </div>
                ...
                {/* JUICIO Section */}
                <div className="border border-black text-xs grid grid-cols-12 mb-8 mt-6">
                  <div className="col-span-2 p-2 font-bold border-r border-black flex items-center justify-center uppercase text-center">
                    JUICIO
                  </div>
                  <div className="col-span-5 p-2 border-r border-black text-[10.5px] flex items-center leading-tight">
